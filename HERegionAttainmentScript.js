...
map.on('load', function() {
  ...
  map.addLayer({
    ...
    'source': {
      type: 'vector',
      url: 'mapbox://johndinning.19oh7aup'
    },
  ...
  map.addLayer({
    ...
    'source': {
        type: 'vector',
        url: 'mapbox://johndinning.411wn3aj'
    },
    ...
    'paint': {
      ...
      map.addLayer({
        ...
        'source': {
            type: 'vector',
            url: 'mapbox://johndinning.8hp6plho'
        },
      ...
      map.addLayer({
        ...
        'source': {
            type: 'vector',
            url: 'mapbox://johndinning.100b16i7'
        },
        ...
        'source': {
            type: 'vector',
            url: 'mapbox://johndinning.0yt7dy2n'
        },
    ...
    map.style.sourceCaches['attribution-layer']._source.attribution =  "&copy; THECB 2017".link("http://www.thecb.state.tx.us/")
